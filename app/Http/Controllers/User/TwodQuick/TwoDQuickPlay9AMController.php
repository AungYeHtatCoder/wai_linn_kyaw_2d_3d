...
class TwoDQuickPlay9AMController extends Controller
{
    ...
    return view('frontend.twoD.9AM.twoDQuickPlayAM', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
    ...
    return view('frontend.twoD.9AM.twoDQuickPlayAMConfirm', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
