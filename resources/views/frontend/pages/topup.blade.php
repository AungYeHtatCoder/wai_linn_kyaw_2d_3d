...
<div class="container-fluid py-5 my-5">
    <!-- header -->
    <p class="text-center">ငွေဖြည့်မည်</p>
    <p class="text-start mb-5">မိမိငွေဖြည့်မည့် ဘဏ်တစ်ခု ရွေးပါ</p>
    <!-- header -->
    <!-- sub menu -->
    <div class="">
    ...
    <p class="text-center mt-5">လက်ကျန်ငွေ: {{ number_format(Auth::user()->balance) }} ကျပ်</p>
    <hr>
    <!-- sub menu -->
