        ...
        <div class="d-flex justify-content-between">
            <div>
                ...
                <div class="mt-4">
                    ...
                    <a href="{{ route('user.twoDQuickPlay4PM') }}" class="btn btn-sm btn-purple text-white">အမြန်ရွေး</a>
                </div>
            </div>
            <div>
             ...
             <div class="p-1">
               ...
               <div class="row">
                ...
                <div class="d-flex justify-content-end mt-4">
                    ...
                    <a href="{{ route('user.twoDPlay4PMConfirm') }}" onclick="storeSelectionsInLocalStorage()" class="btn btn-sm btn-purple text-white" style="font-size: 14px;">ထိုးမည်</a>
                </div>
