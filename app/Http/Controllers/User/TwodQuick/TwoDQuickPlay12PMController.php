...
class TwoDQuickPlay12PMController extends Controller
{
    ...
    return view('frontend.twoD.12PM.twoDQuickPlayPM', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
    ...
    return view('frontend.twoD.12PM.twoDQuickPlayPMConfirm', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
