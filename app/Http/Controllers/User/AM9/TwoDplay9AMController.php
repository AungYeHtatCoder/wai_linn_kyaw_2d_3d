...
class TwoDplay9AMController extends Controller
{
    ...
    return view('frontend.twoD.9AM.twoDPlayAM', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
    ...
    return view('frontend.twoD.9AM.twoDPlayAMConfirm', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
