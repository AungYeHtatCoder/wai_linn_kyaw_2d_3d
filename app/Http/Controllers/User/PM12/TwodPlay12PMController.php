...
class TwodPlay12PMController extends Controller
{
    ...
    return view('frontend.twoD.12PM.twoDPlayPM', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
    ...
    return view('frontend.twoD.12PM.twoDPlayPMConfirm', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
