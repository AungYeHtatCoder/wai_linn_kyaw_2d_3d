...
class TwodPlay2PMController extends Controller
{
    ...
    return view('frontend.twoD.2PM .twoDPlay2PM', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
    ...
    return view('frontend.twoD.2PM.twoDPlay2PMConfirm', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
