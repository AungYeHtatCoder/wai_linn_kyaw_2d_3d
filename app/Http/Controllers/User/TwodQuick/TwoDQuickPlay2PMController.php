...
class TwoDQuickPlay2PMController extends Controller
{
    ...
    return view('frontend.twoD.2PM .twoDQuickPlay2PM', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
    ...
    return view('frontend.twoD.2PM.twoDQuickPlay2PMConfirm', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
