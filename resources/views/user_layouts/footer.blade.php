                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 offset-lg-3 offset-md-3 col-12 footer-border-purple py-3 footer-border">
                            <div class="d-flex justify-content-around footer">
                                ...
                                @endguest
                                <a href="{{ route('user.promo') }}" class="text-decoration-none d-block footer-link {{ Route::currentRouteNamed('user.promo') ? 'active' : '' }}">
                                    <i class="fas fa-gift"></i>
                                </a>
                                <a href="{{ route('user.contact') }}" class="text-decoration-none d-block footer-link {{ Route::currentRouteNamed('user.contact') ? 'active' : '' }}">
