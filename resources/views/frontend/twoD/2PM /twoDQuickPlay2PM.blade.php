...
<div class="">
        ...
        <div class="d-flex justify-content-between">
            <div>
                ...
                <div class="mt-4">
                    ...
                    <a href="{{ route('user.twoDPlay2PM') }}" class="btn btn-sm btn-purple text-white">ပုံမှန်ရွေး</a>
                </div>
            </div>
    ...
    <form action="" method="post" class="p-1">
        ...
        <div class="d-flex justify-content-end my-2" >
            ...
            <a href="{{ route('user.twoDQuickPlay2PMConfirm') }}" onclick="storeSelectionsInLocalStorage()" class="btn btn-sm btn-purple text-white"><small>ထိုးမည်</small></a>
        </div>
