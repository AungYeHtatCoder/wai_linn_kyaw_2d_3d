...
class TwoDQuickPlay4PMController extends Controller
{
    ...
    return view('frontend.twoD.4PM.twoDQuickPlayPM', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
    ...
    return view('frontend.twoD.4PM.twoDQuickPlayPMConfirm', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
