...
class TwodPlay4PMController extends Controller
{
    ...
    return view('frontend.twoD.4PM.twoDPlayPM', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
    ...
    return view('frontend.twoD.4PM.twoDPlayPMConfirm', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
